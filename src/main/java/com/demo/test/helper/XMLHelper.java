...
public final class XMLHelper {
    ...
    public static String xml2xsl(String xmlFilePath, String xsl) throws Exception {
        ...
        Source xmlSource = null, xslSource = null;
        try (StringWriter writer = new StringWriter()) {
            xmlSource = new StreamSource(new File(xmlFilePath));
            xslSource = new StreamSource(new File(xsl));
    ...
    public static Document getDocument(File xmlFile) {
        try {
            ...
            ex.printStackTrace();
            logger.error("读取xml文件出错，返回null" + ex.getMessage());
            return null;
        }
    }
    ...
    public static boolean savaToFile(Document doc, String filePathName, OutputFormat format) {
        ...
        try {
            ...
            ex.printStackTrace();
            logger.error("写文件出错" + ex.getMessage());
        }
        return false;
    }
